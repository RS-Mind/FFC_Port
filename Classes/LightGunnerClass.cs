...
namespace Ported_FFC_Classic.Classes
{
    class LightGunnerClass : ClassHandler
    {
        public override IEnumerator Init()
        {
            ...
            ClassesRegistry.Register(CardHolder.cards["LMG"], CardType.Branch, CardHolder.cards["Light Gunner"]);
            ClassesRegistry.Register(CardHolder.cards["DMR"], CardType.Branch, CardHolder.cards["Light Gunner"]);
            ClassesRegistry.Register(CardHolder.cards["Assault Rifle"], CardType.Branch, CardHolder.cards["Light Gunner"]);
            yield return null;
        }
